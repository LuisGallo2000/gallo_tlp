...
from .models import Articulo, GrupoArticulo, LineaArticulo, ListaPrecios, Cliente, Vendedor, EstadoOrden 
from .forms import ArticuloForm, ListaPrecioForm  # Necesitarás crear estos forms
...
def home(request):
    ...
    total_usuarios = 0  # Obtener de tu modelo Usuario
...
from django.contrib.auth.decorators import login_required
from .models import Articulo, Cliente, Vendedor, OrdenCompraCliente, ItemOrdenCompraCliente, EstadoEntidades, EstadoOrden, TipoIdentificacion, CanalCliente
from .cart import Cart
import uuid
...
def checkout(request):
    ...
    try:
        ...
        # Obtener tipo de identificación predeterminado (puedes ajustar según tus datos)
        try:
            ...
            cliente = Cliente.objects.create(
                ...
                nro_documento=request.user.username[:11],  # Ejemplo
