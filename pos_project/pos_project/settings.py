...
SECRET_KEY = 'django-insecure-m_jgw5rh-n32^&$(g9)rc1j*x@yx1ac8*pgr5tl$68_^5mx!zs'
...
TEMPLATES = [
    {
        # Template backend to be used, e.g., DjangoTemplates or Jinja2
        'BACKEND': 'django.template.backends.django.DjangoTemplates',

        # Path definition of templates folder
        'DIRS': [BASE_DIR / 'templates'],

        # Tells Django to look for templates inside app directories
        'APP_DIRS': True,
